...
offset_crank_xy = crank_l .* [cos(offset_crank_angles); sin(offset_crank_angles)]; % calculate the [x;y] positions of the crank arm end at time t
...
% piston rod
rod_xy = (head_xy+offset_crank_xy)/2;
